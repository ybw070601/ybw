...
WEIBO_DAILY_HISTORY_FILE = "docs/weibo_daily_history.json"
...
def update_history_general(file_path, current_data_dict, max_points=5040):  # 35天 = 5040点
